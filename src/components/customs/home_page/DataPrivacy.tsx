...
const DataPrivacy = () => {
  return (
    <section className="bg-white  py-16 px-6 md:px-24 flex flex-col md:flex-row items-center justify-between gap-12">
      {/* Text Section */}
      <div className="space-y-6  ">
        <h2 className="text-4xl md:text-5xl font-bold text-[#043873] leading-snug">
          ...
          <span className="relative inline-block">
            ...
            <span className="absolute inset-x-0 bottom-0 h-3 bg-[#4F9CF9] z-0 rounded-md"></span>
          </span>
        </h2>
      ...
      <div className="relative w-full  aspect-square">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-20 h-20 border-2 border-dashed border-blue-400 rounded-xl flex items-center justify-center bg-white shadow-md">
            <Image
              src="/logo.png"
              alt="Logo"
              width={32}
